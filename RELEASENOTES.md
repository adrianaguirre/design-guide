...
**CHANGES**
- Apply proper accessibility requirements (aria-labelledby) to tabs (fixes [https://github.com/adrianaguirre/design-guide/issues  /107]). Updated documentation to reflect previous refactoring.
- Fix for inverse button-group icon bug
- Make `.slds-text-body--small` inherit theme color (fixes [https://github.com/adrianaguirre/design-guide/issues  /123])
- Mark all list utilities "dev-ready" - [www.lifelockdesign.com/utilities/lists]
- Field-level help popover background color token update
- Fix truncation on Sales Path (fixes [https://github.com/adrianaguirre/design-guide/issues  /135])
- Fix chevron alignment on Sales Path - [www.lifelockdesign.com/components/tabs#sales-path]
- Updated demo on buttons > neutral icon to demonstrate "mutton" - [www.lifelockdesign.com/components/buttons#neutral-icon]
...
**NEW COMPONENTS**
- Custom Select container added, normalizes the `<select>` appearance in various browsers (fixes [https://github.com/adrianaguirre/design-guide/issues  /122])
...
**NEW COMPONENTS**
- Added initial state of tabs > sales path www.lifelockdesign.com/components/tabs#sales-path
- Added max-width sizing utilities www.lifelockdesign.com/utilities/sizing
- Added button spacing utilities for stacked and horizontal sets of buttons (both a single class and a wrapper class) www.lifelockdesign.com/components/buttons#overview
- Added stretched button utilities for full-width buttons on small form factors www.lifelockdesign.com/components/buttons#overview
- Dialog Menus for small form factor
  - Action overflow for touch www.lifelockdesign.com/components/menus#action-overflow-for-touch
- Added Edit dialog form for touch devices www.lifelockdesign.com/components/forms#edit-dialog-for-touch
...
- Moved tooltips to popovers, deprecated tooltip section www.lifelockdesign.com/components/popovers#tooltips
- Moved Dropdowns into Menus, deprecated dropdowns sectio www.lifelockdesign.com/components/menus
- Moved Picklist Dropdown Menu into Menus www.lifelockdesign.com/components/menus#picklist
- Moved Multi-Select Picklist into Forms www.lifelockdesign.com/components/forms#multi-select
...
**NEW COMPONENTS**
- Added notifications > prompt (modal-style alert) [www.lifelockdesign.com/components/notifications#prompt](www.lifelockdesign.com/components/notifications#prompt)
- Added Preview Panel Popovers [www.lifelockdesign.com/components/popovers#panels](www.lifelockdesign.com/components/popovers#panels)
- More directional support for popover nubbins [www.lifelockdesign.com/components/popovers#nubbins](www.lifelockdesign.com/components/popovers#nubbins)

## Release 0.10.2 - October 29, 2015
- Updated Icons to version 3.2.0
- Dropdown menus now have bottom positioning support, with accommodating nubbin support [www.lifelockdesign.com/components/menus#dropdown-positioning](www.lifelockdesign.com/components/menus#dropdown-positioning)
- Added Google Analytics

## Release 0.10.1 - October 21, 2015
- Hot fix for picklist width on datepicker
- `.slds-is-required` and `.slds-has-error` on form elements are now properly scoped within the `-mx`, `-ldg` and `-scoped` compiled css files
...
- Upgraded `@adrianaguirre/design-tokens` to 1.3.1
- `@adrianaguirre/design-guide` package now includes */assets/icons* and */assets/images*
...
- Full-width button variant for small form factors www.lifelockdesign.com/components/buttons#responsive
- Feed and Comment components have been added www.lifelockdesign.com/components/feeds
- Publisher component has been added www.lifelockdesign.com/components/publishers
...
- Open Sourced: github.com/salesforce-ux/design-guide
